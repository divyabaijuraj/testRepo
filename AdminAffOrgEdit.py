...
class AdminEditAffiliateOrganisation(BaseFunc):
    text_alertskip_xpath = "//button[@title='Skip']"
    ##Admin>program>Aff Org>Org name>Edit
    ...
    button_edit_xpath="//table/tbody/tr[1]/td[5]/button[1]"
   ...
   ##################Affiliation Quick Action###################
    ...
    def EditAffOrg(self, member_username):
        ...
        organization_name = self.wait_presence_of_element_located(By.XPATH,
                                                                  "//*[text()='" + member_username.upper() + "']")
        ...
        if (organization_name.text is None):
            ...
            self.wait_presence_of_element_located(By.XPATH,
                                                  "//th[text()='" + member_username.upper() + "']//parent::tr/td[1]/button").click()
            time.sleep(2)
        self.wait_presence_of_element_located(By.XPATH,self.button_edit_xpath).click()
        time.sleep(2)
